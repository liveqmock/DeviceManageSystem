        ...
        <script type="text/javascript">
            Ext.onReady(function(){                      
                var TableRecord=Ext.data.Record.create([
                    {name:"idActionModuleGroup",type:"int",mapping:"idActionModuleGroup"},
                ...
                var proxy_grid=new Ext.data.HttpProxy({
                    url:'/DeviceManageSystem/ActionmodulegroupManager/LoadDataToGridPanel.action',
                    method : 'post' 
                });
                    ...
                    tbar:[
                        {
                            ...
                            iconCls:"add",
                            handler : function(){
                                var initValue={idActionModuleGroup:null,name:"新功能模块类别"};
                                            ...
                                            for(var i=view.getRows().length-1;i>=0;i--){
                                                if(sm.isSelected(i)){
                                                    ...
                                                    if(store_grid.modified.indexOf(deleterecord)==-1){
                                                        ...
                                                        if(deleterecord.get('idActionModuleGroup')!=null){  
                ...
                function deleteData(modified) {  
                    ...
                    if (json.length > 0) {  
                        Ext.Ajax.request({  
                            url: "/DeviceManageSystem/ActionmodulegroupManager/DeleteDataToDb.action",  
                ...
                function updateData(modified) {  
                    ...
                    if (json.length > 0) {  
                        Ext.Ajax.request({  
                            url: "/DeviceManageSystem/ActionmodulegroupManager/UpdateDataToDb.action",  
                            params: { data: Ext.util.JSON.encode(json) },  
                            method: "POST",  
                            success: function(response) {  

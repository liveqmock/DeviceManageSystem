    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            Ext.onReady(function(){ 
                ...
                function ConsumeDevicePanel_deviceManager(){
                ...
                function ConsumeDevicePanel_deviceTree(p){
                ...
                function createConsumeDevicePanel(){
                    var p1_1=ConsumeDevicePanel_deviceManager();
                    var tr1=ConsumeDevicePanel_deviceTree(p1_1);
                ...
                function createdevicesManagerPanel(){
                    var devicesManagerPanel=new Ext.Panel({
                        ...
                        renderTo : "content", 
                        autoWidth : true,
                        items:[createConsumeDevicePanel()]
                    });
